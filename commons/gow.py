### credits:
### https://github.com/Tixierae/gow_tools/blob/master/Python/library.py
import re 
import itertools
import operator
import copy
...
def terms_to_graph(terms_sents, w):
    ...
    # add vertices
    terms_sorted = sorted(set(chain(*terms_sents)))
    g.add_vertices(terms_sorted)
